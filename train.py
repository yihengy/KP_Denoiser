...
parser.add_argument("--outf", type=str, default="logs/kp_1013", help='path of log files')
...
parser.add_argument("--outKerSize", type=int, default=11, help="Output kernel size")
